...
export default function Hero() {
  ...
  return <section className="relative min-h-[70vh] flex items-center justify-center bg-[#f8f9fa] overflow-hidden">
...
 Corner of Africa</h1>
        ...
        animationDelay: '0.2s'
          ...
          Discover premium African products crafted for excellence
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{
        animationDelay: '0.3s'
      }}>
          <Button onClick={scrollToCollections} size="lg" className="bg-brand-dark hover:bg-brand-dark/90 text-white text-lg px-8 py-6 shadow-md transition-transform hover:-translate-y-1">
