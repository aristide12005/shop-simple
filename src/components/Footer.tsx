    ...
    <footer id="contact" className="bg-foreground text-background py-12">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-background/70">
              <li className="flex items-start gap-3">
                ...
                <span>181 Principale St A-10, Gatineau, Quebec J9H 6A6, Canada</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 flex-shrink-0" />
                <a href="mailto:djmadeinafrica@gmail.com" className="hover:text-background transition-colors">
                  djmadeinafrica@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-4 w-4 flex-shrink-0" />
                <a href="tel:+18738701940" className="hover:text-background transition-colors">
                  +1 873-870-1940
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-background/20 mt-8 pt-8 text-center text-sm text-background/50">
          <p>&copy; 2026 Accicoa. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
